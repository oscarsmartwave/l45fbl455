                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="panel-body">
                            <div class="row">
                                <div class="col-lg-6">
                                    <form id="addform" role="form" action="<?php echo base_url(); ?>operators/add/" method="post" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="file" class="form-control" name="uploadPhoto" placeholder="Photo" accept="image/*" required>
                                        </div>
