...
<head>
    ...
    <!-- Timeline CSS -->
    <link href="<?php echo asset_url();?>/dist/css/timeline.css" rel="stylesheet">

    <!-- Custom CSS -->
    <link href="<?php echo asset_url();?>/dist/css/sb-admin-2.css" rel="stylesheet">

    <!-- Morris Charts CSS -->
    <link href="<?php echo asset_url();?>/bower_components/morrisjs/morris.css" rel="stylesheet">
            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <!-- Operators -->
                        <li>
                            <a href="#operators"><i class="fa fa-hand-spock-o fa-fw"></i></i> Operators<span class="fa arrow"></a>
                            <ul class="nav nav-second-level">
                                <li>
                        ...
                        <!-- Users -->
                        <li>
                            <a href="#Users"><i class="fa fa-user fa-fw"></i></i> Users<span class="fa arrow"></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="#view-all">View All</a>
                                </li>
                        ...
                        <!-- Apointments -->
                        <li>
                            <a href="#Users"><i class="fa fa-space-shuttle fa-fw"></i></i> Appointments<span class="fa arrow"></a>
                            <ul class="nav nav-second-level">
                                <li>
                                    <a href="#view-all">View All</a>
                                </li>
                                <li>
                                    <a href="#operator">Per Operator</a>
                                </li>
                                <li>
